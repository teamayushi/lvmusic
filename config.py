...
OWNER_ID = int(getenv("OWNER_ID", 6361643700))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ifgovtjoftibcdjpvd8nfiokbfobffob0vrb8bd/asuumusic",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+O4jsw5HIsYMyODU9")
